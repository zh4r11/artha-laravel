...
<div class="slider-area">
    <div class="slider-active-3 owl-carousel slider-hm8 owl-dot-style">
        ...
        <!-- Slider Single Item Start -->
        <div class="slider-height-6 d-flex align-items-start justify-content-start bg-img" style="background-image: url({{ asset('storage/assets/images/slider-image/slider22.png') }});">
            <div class="container">
                <div class="slider-content-1 slider-animated-1 text-left">
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12 mt-res-sx-30px">
                <div class="banner-wrapper">
                    <a href="shop-4-column.html"><img src="{{ asset('storage/assets/images/banner/banner2c.png') }}" alt="" /></a>
                </div>
            </div>
