...
<head>
  ...
  <title>Login &mdash; Prestige Aqiqah</title>
                ...
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="phone" class="form-control phone-number" id="phone" name="phone" tabindex="1" placeholder="Phone" required autofocus>
